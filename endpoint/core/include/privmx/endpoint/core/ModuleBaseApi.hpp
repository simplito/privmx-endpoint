...
auto ModuleBaseApi::decryptModuleDataV4(
    ...
    try {
        auto encryptedData = core::dynamic::EncryptedModuleDataV4_c_struct::formJSON(moduleObj.data);
...
auto ModuleBaseApi::decryptModuleDataV5(
    ...
    try {
        auto encryptedData = core::dynamic::EncryptedModuleDataV5_c_struct::formJSON(moduleObj.data);
