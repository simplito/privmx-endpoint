...
void StructValidator<PagingList<thread::Thread>>::validate(
    const PagingList<thread::Thread>& value,
...
void StructValidator<thread::ServerMessageInfo>::validate(
    const thread::ServerMessageInfo& value,
    const std::string& stack_trace
) {
    Validator::validateId(value.threadId, stack_trace + ".threadId");
...
void StructValidator<core::PagingList<thread::Message>>::validate(
    const core::PagingList<thread::Message>& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadCreatedEvent>::validate(
    const thread::ThreadCreatedEvent& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadUpdatedEvent>::validate(
    const thread::ThreadUpdatedEvent& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadDeletedEventData>::validate(
    const thread::ThreadDeletedEventData& value,
    const std::string& stack_trace
) {
    Validator::validateId(value.threadId, stack_trace + ".threadId");
}

void StructValidator<thread::ThreadDeletedEvent>::validate(
    const thread::ThreadDeletedEvent& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadStatsEventData>::validate(
    const thread::ThreadStatsEventData& value,
    const std::string& stack_trace
) {
    Validator::validateId(value.threadId, stack_trace + ".threadId");
}

void StructValidator<thread::ThreadStatsChangedEvent>::validate(
    const thread::ThreadStatsChangedEvent& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadNewMessageEvent>::validate(
    const thread::ThreadNewMessageEvent& value,
    const std::string& stack_trace
) {
...
void StructValidator<thread::ThreadDeletedMessageEventData>::validate(
    const thread::ThreadDeletedMessageEventData& value,
    const std::string& stack_trace
) {
    Validator::validateId(value.threadId, stack_trace + ".threadId");
    Validator::validateId(value.messageId, stack_trace + ".messageId");
...
void StructValidator<thread::ThreadMessageDeletedEvent>::validate(
    const thread::ThreadMessageDeletedEvent& value,
    const std::string& stack_trace
) {
