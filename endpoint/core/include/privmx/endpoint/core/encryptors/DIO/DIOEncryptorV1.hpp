...
public:
    std::string signAndEncode(const core::DataIntegrityObject& dio, const privmx::crypto::PrivateKey& autorKey);
    core::DataIntegrityObject decodeAndValidate(const std::string& signedDio);
private:
