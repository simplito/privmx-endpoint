...
#define STREAM_ROOM_INFO_EXTRA_FIELDS(F)                                                                               \
    ...
    F(streamRoomTtl, std::optional<int64_t>)
...
#define STREAM_ROOM_CREATE_MODEL_EXTRA_FIELDS(F) F(streamRoomTtl, std::optional<int64_t>)
...
#define STREAM_ROOM_DELETE_MODEL_FIELDS(F) F(id, std::string)
...
#define STREAM_GET_TURN_CREDENTIALS_RESULT_FIELDS(F) F(credentials, std::vector<TurnCredentials>)
...
#define STREAM_ROOM_JOIN_MODEL_FIELDS(F) F(streamRoomId, std::string)
...
#define STREAM_UPDATED_EVENT_DATA_FIELDS(F)                                                                            \
    ...
    F(streamId, int64_t)                                                                                               \
    F(userId, std::string)                                                                                             \
    F(tracksAdded, std::vector<StreamTrackInfo>)                                                                       \
