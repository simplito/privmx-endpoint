...
public:
    ...
    static StreamApiLow create(const core::Connection& connection, event::EventApi& eventApi, StreamEncryptionMode streamEncryptionMode = StreamEncryptionMode::MULTIPLE_KEY);
    StreamApiLow();
