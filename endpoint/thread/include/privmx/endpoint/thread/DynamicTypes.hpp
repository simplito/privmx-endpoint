...
#define I_MESSAGE_DATA_FIELDS(F) F(v, int64_t)
...
#define MESSAGE_DATA_V2_SIGNED_FIELDS(F) F(data, MessageDataV2)
...
#define MESSAGE_DATA_V3_SIGNED_FIELDS(F) F(data, MessageDataV3)
