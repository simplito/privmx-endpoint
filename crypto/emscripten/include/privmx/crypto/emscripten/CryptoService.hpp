...
#ifndef _PRIVMXLIB_CRYPTO_EMSCRIPTEN_CRYPTOSERVICE_HPP_
#define _PRIVMXLIB_CRYPTO_EMSCRIPTEN_CRYPTOSERVICE_HPP_
...
private:
    std::string hmac(const std::string& engine, const std::string& key, const std::string& data) const;
};
...
#endif // _PRIVMXLIB_CRYPTO_EMSCRIPTEN_CRYPTOSERVICE_HPP_
