...
DECLARE_ENDPOINT_EXCEPTION(EndpointCoreException, NoUserEntryForGivenKeyIdException, "No user entry for given key id", 0x0001, __ERR_DESC_NoUserEntryForGivenKeyIdException)
...
DECLARE_ENDPOINT_EXCEPTION(EndpointConnectionException, NotInitializedException, "Endpoint not initialized", 0x0001, __ERR_DESC_NotInitializedException)
