...
const std::map<EventType, std::string> SubscriberImpl::_eventTypeNames = {
    {EventType::STORE_CREATE, "create"}, {EventType::STORE_UPDATE, "update"},
    {EventType::STORE_DELETE, "delete"}, {EventType::STORE_STATS, "stats"},
    {EventType::FILE_CREATE, "create"},  {EventType::FILE_UPDATE, "update"},
    {EventType::FILE_DELETE, "delete"},  {EventType::COLLECTION_CHANGE, "collectionChanged"}
};
...
const std::map<EventType, std::string> SubscriberImpl::_readableEventType = {
    {EventType::STORE_CREATE, "STORE_CREATE"}, {EventType::STORE_UPDATE, "STORE_UPDATE"},
    {EventType::STORE_DELETE, "STORE_DELETE"}, {EventType::STORE_STATS, "STORE_STATS"},
    {EventType::FILE_CREATE, "FILE_CREATE"},   {EventType::FILE_UPDATE, "FILE_UPDATE"},
    {EventType::FILE_DELETE, "FILE_DELETE"},   {EventType::COLLECTION_CHANGE, "COLLECTION_CHANGE"}
};
