...
std::string EncKeyEncryptorV1::encrypt(const std::string& rawKey, const privmx::crypto::PublicKey& encryptionKey) {
    return crypto::EciesEncryptor::encryptToBase64(encryptionKey, rawKey);
}
