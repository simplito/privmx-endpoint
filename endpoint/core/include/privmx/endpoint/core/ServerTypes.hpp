...
#define CONTEXT_GET_MODEL_FIELDS(F) F(id, std::string)
JSON_STRUCT(ContextGetModel, CONTEXT_GET_MODEL_FIELDS);

#define CONTEXT_LIST_USERS_MODEL_FIELDS(F) F(contextId, std::string)
JSON_STRUCT_EXT(ContextListUsersModel, ListModel, CONTEXT_LIST_USERS_MODEL_FIELDS);

#define CONTEXT_GET_RESULT_FIELDS(F) F(context, ContextInfo)
...
#define UNSUBSCRIBE_FROM_CHANNELS_MODEL_FIELDS(F) F(subscriptionsIds, std::vector<std::string>)
JSON_STRUCT(UnsubscribeFromChannelsModel, UNSUBSCRIBE_FROM_CHANNELS_MODEL_FIELDS);

#define SUBSCRIBE_TO_CHANNELS_MODEL_FIELDS(F) F(channels, std::vector<std::string>)
...
#define SUBSCRIBE_TO_CHANNELS_RESULT_FIELDS(F) F(subscriptions, std::vector<Subscription>)
