...
inline const std::unordered_map<std::string, func_enum> functions_endpoint = {
    ...
    {"thread.rotateThreadKeys", thread_rotateThreadKeys},
    ...
    {"store.rotateStoreKeys", store_rotateStoreKeys},
    ...
    {"inbox.rotateInboxKeys", inbox_rotateInboxKeys},
    ...
    {"kvdb.rotateKvdbKeys", kvdb_rotateKvdbKeys},
    ...
    {"group.addGroupMembers", group_addGroupMembers},
    {"group.removeGroupMembers", group_removeGroupMembers},
    {"group.updateGroupPublicMeta", group_updateGroupPublicMeta},
    {"group.updateGroupPrivateMeta", group_updateGroupPrivateMeta},
    {"group.updateGroupPolicy", group_updateGroupPolicy},
    {"group.deleteGroup", group_deleteGroup},
    {"group.getGroup", group_getGroup},
    {"group.listGroups", group_listGroups},
