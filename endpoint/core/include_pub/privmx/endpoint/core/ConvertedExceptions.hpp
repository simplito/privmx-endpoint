...
DECLARE_ENDPOINT_EXCEPTION(EndpointServerException, InvalidKeyException, "Invalid key", 0x0070)
...
DECLARE_ENDPOINT_EXCEPTION(EndpointServerException, StoreFileVersionMismatchException, "Store file version mismatch", 0x6128)
...
DECLARE_ENDPOINT_EXCEPTION(EndpointLibException, FailedToParseJSONString, "Failed to parce JSON string", 0x0008);
