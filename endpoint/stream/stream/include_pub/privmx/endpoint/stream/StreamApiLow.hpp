...
public:
    ...
    static StreamApiLow create(const core::Connection& connection, event::EventApi& eventApi, StreamVideoEncryptionMode videoEncryptionMode = StreamVideoEncryptionMode::MULTIPLE_KEY);
    StreamApiLow();
