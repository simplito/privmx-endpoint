...
#include "privmx/endpoint/store/StoreExceptionDiscriptions.hpp"
...
DECLARE_ENDPOINT_EXCEPTION(EndpointStoreException, NotInitializedException, "Endpoint not initialized", 0x0001, __ERR_DESC_NotInitializedException)
