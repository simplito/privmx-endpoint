...
public:
     ...
     * not it names the group in `groups`: the grantee list comes from the KVDB itself, and any epoch public key
     ...
     * KVDB's grantee groups, and cannot supply their epoch keys in `groups` either, gets
