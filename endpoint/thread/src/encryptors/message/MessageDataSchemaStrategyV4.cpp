...
Message MessageDataSchemaStrategyV4::toLibError(const server::Message& message, int64_t errorCode) const {
    return MessageDataSchemaMapper::toLibMessage(message, {}, {}, {}, {}, errorCode, MessageDataSchema::Version::VERSION_4);
}
