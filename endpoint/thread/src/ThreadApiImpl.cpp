...
std::string ThreadApiImpl::_createThreadEx(
    ...
    ThreadDataToEncryptV5 threadDataToEncrypt {
        ...
        .internalMeta = ThreadInternalMetaV5{.secret=threadSecret, .resourceId=resourceId, .randomId=threadDIO.randomId},
        .dio = threadDIO
    };
...
void ThreadApiImpl::updateThread(
    ...
    ThreadDataToEncryptV5 threadDataToEncrypt {
        .publicMeta = publicMeta,
        .privateMeta = privateMeta,
        .internalMeta = ThreadInternalMetaV5{.secret=threadInternalMeta.secret, .resourceId=currentThreadResourceId, .randomId=updateThreadDio.randomId},
        .dio = updateThreadDio
    };
...
std::string ThreadApiImpl::sendMessage(const std::string& threadId, const core::Buffer& publicMeta, const core::Buffer& privateMeta, const core::Buffer& data) {
    ...
    switch (getThreadEntryDataStructureVersion(thread.data().get(thread.data().size()-1))) {
        case ThreadDataSchemaVersion::VERSION_1:
        case ThreadDataSchemaVersion::VERSION_4: {
        ...
        case ThreadDataSchemaVersion::VERSION_5: {
...
DecryptedThreadDataV4 ThreadApiImpl::decryptThreadV4(server::Thread2DataEntry threadEntry, const core::DecryptedEncKey& encKey) {
    try {
        ...
        return DecryptedThreadDataV4{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_4, .statusCode = e.getCode()}, {},{},{},{}};
    } catch (const privmx::utils::PrivmxException& e) {
        return DecryptedThreadDataV4{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_4, .statusCode = core::ExceptionConverter::convert(e).getCode()}, {},{},{},{}};
    } catch (...) {
        return DecryptedThreadDataV4{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_4, .statusCode = ENDPOINT_CORE_EXCEPTION_CODE}, {},{},{},{}};
    }
}
...
DecryptedThreadDataV5 ThreadApiImpl::decryptThreadV5(server::Thread2DataEntry threadEntry, const core::DecryptedEncKey& encKey) {
    try {
        ...
        return DecryptedThreadDataV5{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_5, .statusCode = e.getCode()}, {},{},{},{},{}};
    } catch (const privmx::utils::PrivmxException& e) {
        return DecryptedThreadDataV5{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_5, .statusCode = core::ExceptionConverter::convert(e).getCode()}, {},{},{},{},{}};
    } catch (...) {
        return DecryptedThreadDataV5{{.dataStructureVersion = ThreadDataSchemaVersion::VERSION_5, .statusCode = ENDPOINT_CORE_EXCEPTION_CODE}, {},{},{},{},{}};
    }
}
...
ThreadDataSchemaVersion ThreadApiImpl::getThreadEntryDataStructureVersion(server::Thread2DataEntry threadEntry) {
    if (threadEntry.data().type() == typeid(Poco::JSON::Object::Ptr)) {
        ...
        auto version = versioned.versionOpt(MessageDataSchemaVersion::UNKNOWN);
        switch (version) {
            case ThreadDataSchemaVersion::VERSION_4:
                return ThreadDataSchemaVersion::VERSION_4;
            case ThreadDataSchemaVersion::VERSION_5:
                return ThreadDataSchemaVersion::VERSION_5;
            default:
                return ThreadDataSchemaVersion::UNKNOWN;
        }
    } else if (threadEntry.data().isString()) {
        return ThreadDataSchemaVersion::VERSION_1;
    }
    return ThreadDataSchemaVersion::UNKNOWN;
}
...
DecryptedMessageDataV4 ThreadApiImpl::decryptMessageDataV4(server::Message message, const core::DecryptedEncKey& encKey) {
    try {
        ...
        return DecryptedMessageDataV4{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_4, .statusCode = e.getCode()}, {},{},{},{},{}};
    } catch (const privmx::utils::PrivmxException& e) {
        return DecryptedMessageDataV4{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_4, .statusCode = core::ExceptionConverter::convert(e).getCode()}, {},{},{},{},{}};
    } catch (...) {
        return DecryptedMessageDataV4{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_4, .statusCode = ENDPOINT_CORE_EXCEPTION_CODE}, {},{},{},{},{}};
    }
}
...
DecryptedMessageDataV5 ThreadApiImpl::decryptMessageDataV5(server::Message message, const core::DecryptedEncKey& encKey) {
    try {
        ...
        return DecryptedMessageDataV5{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_5, .statusCode = e.getCode()}, {},{},{},{},{},{}};
    } catch (const privmx::utils::PrivmxException& e) {
        return DecryptedMessageDataV5{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_5, .statusCode = core::ExceptionConverter::convert(e).getCode()}, {},{},{},{},{},{}};
    } catch (...) {
        return DecryptedMessageDataV5{{.dataStructureVersion = MessageDataSchemaVersion::VERSION_5, .statusCode = ENDPOINT_CORE_EXCEPTION_CODE}, {},{},{},{},{},{}};
    }
}
...
MessageDataSchemaVersion ThreadApiImpl::getMessagesDataStructureVersion(server::Message message) {
    ...
    if (message.data().type() == typeid(Poco::JSON::Object::Ptr)) {
        ...
        auto version = versioned.versionOpt(MessageDataSchemaVersion::UNKNOWN);
        switch (version) {
            case MessageDataSchemaVersion::VERSION_4:
                return MessageDataSchemaVersion::VERSION_4;
            case MessageDataSchemaVersion::VERSION_5:
                return MessageDataSchemaVersion::VERSION_5;
            default:
                return MessageDataSchemaVersion::UNKNOWN;
        }
        ...
        if(core::DataEncryptorUtil::hasSign(utils::Base64::toString(message.data()))) {
            return MessageDataSchemaVersion::VERSION_3;
        } else {
            return MessageDataSchemaVersion::VERSION_2;
        }
    }
    return MessageDataSchemaVersion::UNKNOWN;
}
...
std::tuple<Message, core::DataIntegrityObject> ThreadApiImpl::decryptAndConvertMessageDataToMessage(server::Message message, const core::DecryptedEncKey& encKey) {
    switch (getMessagesDataStructureVersion(message)) {
        case MessageDataSchemaVersion::VERSION_2: {
            return std::make_tuple(
        ...
        case MessageDataSchemaVersion::VERSION_3: {
            return std::make_tuple(
