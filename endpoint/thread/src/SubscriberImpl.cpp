...
const std::map<EventType, std::string> SubscriberImpl::_eventTypeNames = {
    {EventType::THREAD_CREATE, "create"},  {EventType::THREAD_UPDATE, "update"},
    {EventType::THREAD_DELETE, "delete"},  {EventType::THREAD_STATS, "stats"},
    {EventType::MESSAGE_CREATE, "create"}, {EventType::MESSAGE_UPDATE, "update"},
    {EventType::MESSAGE_DELETE, "delete"}, {EventType::COLLECTION_CHANGE, "collectionChanged"}
};
const std::map<EventType, std::set<EventSelectorType>> SubscriberImpl::_eventTypeAllowedSelectorTypes = {
    ...
    {EventType::MESSAGE_UPDATE,
     {EventSelectorType::CONTEXT_ID, EventSelectorType::THREAD_ID, EventSelectorType::MESSAGE_ID}},
...
const std::map<EventType, std::string> SubscriberImpl::_readableEventType = {
    {EventType::THREAD_CREATE, "THREAD_CREATE"},   {EventType::THREAD_UPDATE, "THREAD_UPDATE"},
    {EventType::THREAD_DELETE, "THREAD_DELETE"},   {EventType::THREAD_STATS, "THREAD_STATS"},
    {EventType::MESSAGE_CREATE, "MESSAGE_CREATE"}, {EventType::MESSAGE_UPDATE, "MESSAGE_UPDATE"},
    {EventType::MESSAGE_DELETE, "MESSAGE_DELETE"}, {EventType::COLLECTION_CHANGE, "COLLECTION_CHANGE"}
};
