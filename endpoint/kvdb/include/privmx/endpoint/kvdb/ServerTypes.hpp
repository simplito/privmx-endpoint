...
#define KVDB_ROTATE_KEYS_MODEL_EXTRA_FIELDS(F)
JSON_STRUCT_EXT(KvdbRotateKeysModel, core::server::ContainerRotateKeysModelBase, KVDB_ROTATE_KEYS_MODEL_EXTRA_FIELDS);

#define KVDB_DELETE_MODEL_FIELDS(F) F(kvdbId, std::string)
JSON_STRUCT(KvdbDeleteModel, KVDB_DELETE_MODEL_FIELDS);

#define KVDB_DELETE_MANY_MODEL_FIELDS(F) F(kvdbsIds, std::vector<std::string>)
...
#define KVDB_DELETE_MANY_RESULT_FIELDS(F) F(kvdbsIds, std::vector<KvdbDeleteStatus>)
...
#define KVDB_GET_RESULT_FIELDS(F) F(kvdb, KvdbInfo)
...
#define KVDB_LIST_KEYS_MODEL_FIELDS(F) F(kvdbId, std::string)
...
#define KVDB_LIST_ENTRIES_MODEL_FIELDS(F) F(kvdbId, std::string)
...
#define KVDB_ENTRY_DELETE_MANY_RESULT_FIELDS(F) F(results, std::vector<KvdbEntryDeleteStatus>)
...
#define KVDB_ENTRY_EVENT_DATA_FIELDS(F) F(containerType, std::optional<std::string>)
