...
#ifndef _PRIVMXLIB_ENDPOINT_LOCK_EXT_EXCEPTION_HPP_
#define _PRIVMXLIB_ENDPOINT_LOCK_EXT_EXCEPTION_HPP_
...
namespace lock {
// clang-format off
#define ENDPOINT_LOCK_EXCEPTION_CODE 0x000C0000

DECLARE_SCOPE_ENDPOINT_EXCEPTION(EndpointLockException, "Unknown endpoint lock exception", "Lock", 0x000C)

#define LOCK_EXCEPTIONS(X)                                                                                             \
    X(NotInitializedException, "Endpoint not initialized", 0x0001)                                                     \
    X(InvalidLockLevelException, "Invalid lock level value", 0x0002)

#define PRIVMX_LOCK_DECLARE(NAME, MSG, CODE) DECLARE_ENDPOINT_EXCEPTION(EndpointLockException, NAME, MSG, CODE)
LOCK_EXCEPTIONS(PRIVMX_LOCK_DECLARE)
#undef PRIVMX_LOCK_DECLARE

// compile-time guard: codes are collected from the list above, never retyped
#define PRIVMX_LOCK_CODE(NAME, MSG, CODE) NAME::FULL_CODE,
static_assert(
    privmx::endpoint::core::exceptionCodesUnique({LOCK_EXCEPTIONS(PRIVMX_LOCK_CODE)}),
    "Duplicate exception code in lock scope"
);
#undef PRIVMX_LOCK_CODE
#undef LOCK_EXCEPTIONS
// clang-format on
} // namespace lock
} // namespace endpoint
} // namespace privmx
...
#endif // _PRIVMXLIB_ENDPOINT_LOCK_EXT_EXCEPTION_HPP_
