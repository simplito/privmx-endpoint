...
public:
    ...
    static std::vector<CollectionItemChange> mapToCollectionItemChanges(
        const std::vector<server::CollectionItemChange>& data
    );
    static CollectionChangedEventData mapToCollectionChangedEventData(
    ...
    static ContextUsersStatusChangedEventData mapToContextUsersStatusChangedEventData(
