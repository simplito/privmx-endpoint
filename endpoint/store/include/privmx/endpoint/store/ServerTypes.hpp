...
#define BUFFER_READ_RANGE_FIELDS(F) F(type, std::string)
...
#define FILE_LIST_ELEMENT_FIELDS(F) F(error, std::optional<FileError>)
JSON_STRUCT_EXT(FileListElement, File, FILE_LIST_ELEMENT_FIELDS);

#define STORE_FILE_GET_MODEL_FIELDS(F) F(fileId, std::string)
...
#define STORE_FILE_LIST_MODEL_FIELDS(F) F(storeId, std::string)
...
#define STORE_CREATE_RESULT_FIELDS(F) F(storeId, std::string)
JSON_STRUCT(StoreCreateResult, STORE_CREATE_RESULT_FIELDS);

#define STORE_DELETE_MODEL_FIELDS(F) F(storeId, std::string)
...
#define STORE_FILE_CREATE_RESULT_FIELDS(F) F(fileId, std::string)
...
#define STORE_FILE_DELETE_MODEL_FIELDS(F) F(fileId, std::string)
...
#define CREATE_REQUEST_MODEL_FIELDS(F) F(files, std::vector<FileDefinition>)
JSON_STRUCT(CreateRequestModel, CREATE_REQUEST_MODEL_FIELDS);

#define CREATE_REQUEST_RESULT_FIELDS(F) F(id, std::string)
...
#define STORE_FILE_EVENT_DATA_FIELDS(F) F(containerType, std::optional<std::string>)
