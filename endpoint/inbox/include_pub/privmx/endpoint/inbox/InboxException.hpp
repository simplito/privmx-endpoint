...
DECLARE_ENDPOINT_EXCEPTION(EndpointInboxException, InvalidFileReadHandleException, "Invalid file handle: handle is not read handle", 0x0016)
DECLARE_ENDPOINT_EXCEPTION(EndpointInboxException, InvalidFileWriteHandleException, "Invalid file handle: handle is not write handle", 0x0017)
